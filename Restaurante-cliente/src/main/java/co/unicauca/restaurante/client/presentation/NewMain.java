...
public class NewMain {
    ...
    public static void main(String[] args) {
        ...
        PlatoDia platoDia = new PlatoDia(555,"Corrientaso",7000,"",DiaEnum.Lunes,"Sancocho","Frijoles","Res Asado","Tomate",menuDia.getId());
        PlatoEspecial platoEspecial = new PlatoEspecial(5555,"Bandeja Paisa",14000,"PAISITA :3",menuEspecial.getId());
        try{
